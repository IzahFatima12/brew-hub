import {
  ...
  import coffees from "../config/coffees"; // Assuming you have a coffees array in config
  ...
  const CoffeeDetails = ({ route, navigation }) => {
    ...
    // Filter coffees to exclude the current coffee
    const recommendedCoffees = coffees.filter(item => item.id !== coffee.id);
    ...
    return (
      <>
        ...
        <SafeAreaView
          style={{ flexDirection: "row", justifyContent: "space-between", marginBottom: SPACING }}
        >
          <View
            style={{
              padding: SPACING,
        ...
        <View style={{ paddingHorizontal: SPACING, marginBottom: SPACING * 2 }}>
          <Text
            style={{
              color: colors["white-smoke"],
              fontSize: SPACING * 1.7,
